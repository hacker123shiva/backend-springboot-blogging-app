...
public class SwagggerConfig {
	...
	private ApiInfo getInfo() {
		...
		return new ApiInfo("Blogging Application",
				"This project is developed by Shiva Srivastava", "1.0", "Terms of Service",
				new Contact("Shiva Srivastava", "https://github.com/hacker123shiva", "india2020ballia@gmail.com"),
				"MIT License", "license", Collections.emptyList());
	};
